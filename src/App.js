...
// import { withdrawSol , transferSol } from './transfer-sol/index.ts';
import WithdrawSol from './transfer-sol/withdraw';
import CollapsibleExample from './Screens/navigtionbar';
...
function App() {
  ...
  function signInTransactionAndSendMoney() {
    ...
    (async () => {
      ...
      if (parseFloat(walletText) > 0.001) {
        ...
        try {
          var destPubkeyStr = "rd4mx1NKr8Au7UYua3Z7mjSfa5xFW95iz55raoDMAqs";
  ...
  return (
    ...
    <CollapsibleExample />
      ...
      <hr></hr>
      <p> WITHDRAW SOL FROM Raham to Arham </p>
      <WithdrawSol />
      <SlotMachine />
    </div>
  );
